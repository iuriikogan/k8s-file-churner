...
export PVC_SIZE_GB=30 # int - size of PVCs (for each PVC a deployment will be created and a pod mounted
export SIZE_OF_FILES_MB=1 # int - the size of files to be created per PVC
export STORAGE_CLASS_NAME="managed-premium" # string - ***only RWO storage classes*** TODO add logic for RWX storage classes
